...
module Decidim
  module Admin
    ...
    class FormBuilder < Decidim::FormBuilder
      ...
      #   - :label (boolean|string) You can disable the creation of the input label passing false, or override the default
      #       label passing a string (default: name of the input)
      ...
      #      options = { label: t(".user"), multiple: false } %>
      ...
      def autocomplete_select(attribute, selected = nil, options = {}, prompt_options = {})
        ...
        content_tag(:div, class: "autocomplete-field") do
          template = ""
